...
| Thứ 3 | - Thực hành tích hợp Cognito User Pool + JWT authorizer; phân quyền RBAC chat/admin <br> - Hoàn thiện FastAPI backend: route chat, admin upload, health check | 04/08/2026 | 04/08/2026 | [AWS Cognito](https://000081.awsstudygroup.com/vi/) <br> Source code auth.py, api/ |
...
| Thứ 5 | - Xây dựng ingestion serverless: S3 event → SQS → Lambda <br> - Cấu hình retry/DLQ; deploy foundation.yaml qua CloudFormation | 06/08/2026 | 06/08/2026 | infra/foundation.yaml <br> [Workshop S3 upload](/vi/5-workshop/5.3-s3-upload/) |
| Thứ 6 | - Hoàn thành Worklog tuần 5–7, Event 2 và Blogs 1, 2, 3 <br> - Kiểm thử end-to-end: upload → ingest → hỏi đáp → citation | 07/08/2026 | 07/08/2026 | [hcm-rules.awsfcaj.com](https://hcm-rules.awsfcaj.com/) |
