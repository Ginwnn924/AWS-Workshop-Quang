...
Tại phần này, tôi trình bày đề xuất dự án thực tập: xây dựng **Vietnamese Legal RAG Chatbot** — hệ thống hỏi đáp văn bản pháp luật Việt Nam trên nền tảng AWS, kết hợp Retrieval-Augmented Generation (RAG) và các dịch vụ cloud-native.
